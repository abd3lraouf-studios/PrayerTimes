...
خام کوآرڈینیٹس کے بجائے شہر کا نام دکھانے کے لیے ایپ آپ کی پوزیشن کو ~1.1 کلومیٹر تک گول کر کے Apple کے جیو کوڈر سے نام مانگتی ہے۔ اسی گول کیے گئے کوآرڈینیٹ کو **OpenStreetMap Nominatim** کو بھیجنا — جس کی ضرورت انڈونیشی، فارسی اور اردو کو درست املا والے نام کے لیے ہوتی ہے — **بطورِ طے شدہ بند ہے** اور «اوقاتِ نماز ← مقام» سے فعال کیا جا سکتا ہے۔ مقام منتخب کرنے والے میں شہر لکھتے وقت صرف وہی متن بھیجا جاتا ہے جو آپ لکھتے ہیں۔ پرو آڈیو (اذان کلپس اور اذکار کے قاری) ضرورت کے مطابق ایپ کے اپنے سرور سے ڈاؤن لوڈ ہوتی ہے، جو پہلے آپ کا پرو فعال ہونا جانچتا ہے۔ App Store کا نسخہ App Store کے ذریعے اپڈیٹ ہوتا ہے، جبکہ براہِ راست نسخہ اپنی اپڈیٹس خود دیکھتا ہے۔

اذان کے دوران میڈیا روکنا اختیاری ہے۔ جب آپ رازداری اور حفاظت ← آٹومیشن میں اجازت دیں تو ایپ Music، TV یا Spotify سے — صرف وہ جو پہلے سے چل رہا ہو — پوچھتی ہے کہ کیا وہ چل رہا ہے، اور اسے روکنے اور دوبارہ چلانے کو کہتی ہے، اس کے سوا کچھ نہیں۔ سفر موڈ آپ کا گھر اور موجودہ مقام اسی میک پر رکھتا ہے؛ ان میں سے کوئی بھی سِنک یا بھیجا نہیں جاتا۔
